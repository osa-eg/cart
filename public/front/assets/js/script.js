...
(function ($) {
    ...
    $('#vPlus').on('click', function () {
        ...
        var $input =  $('#addToCartFormModal .qty');
    ...
    $('#vShowMinus').on('click', function () {
        var $qty = $('.qty-box .input-number');
        var $input =  $('.addToCartForm .qty');
        var currentVal = parseInt($qty.val(), 10);

        $('#maxShowQuntity').hide();
        var $max =  $('#vShowPlus').data('max');
        if(currentVal >= parseInt($max)) {
            currentVal = parseInt($max);
            $input.val($max);
...
$(document).on('click', '#showColorList li', function() {
    $(".color-variant li").removeClass("active");
    var id = $(this).data('id');
    $('.addToCartForm .color_id').val(id);
    $(this).addClass("active");
});
$(document).on('click', '#colorList li', function() {
    ...
    var id = $(this).data('id');
    $('#addToCartFormModal .color_id').val(id);
    $(this).addClass("active");
});
