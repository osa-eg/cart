                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-contant">
                        <div class="footer-logo">
                            <img src="{{asset('logo/logo_'.app()->getLocale().'.png')}}" alt="">
                        </div>
                    ...
                    <div class="sub-title">
                        ...
                        <div class="footer-contant">
                            <ul class="contact-list">
                                <li><i class="fa fa-map-marker"></i> Demo Store, Demo store India
                                    345-659</li>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                    <div class="footer-end">
                        <p><i class="fa fa-copyright" aria-hidden="true"></i> {{date('Y')}} all right received</p>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6 col-sm-12">
