    ...
    <nav class="breadcrumb-header bg-white justify-content-between p-3 rounded-5">
        <div>
            <ol class="breadcrumb bg-transparent ">
                ...
                <li class="breadcrumb-item text-sm "><a class="opacity-5 " href="{{route('user.index')}}">{{__('user.title')}}</a></li>
                <li class="breadcrumb-item text-sm  active" aria-current="page">{{__('user.details')}}</li>
            </ol>
            <h6 class="font-weight-bolder">{{$user->name}}</h6>
        </div>
        <div>
            <a href="{{route('user.toggle_active',$user)}}" class="btn  @if($user->active) btn-outline-secondary @else  btn-outline-success @endif btn-sm py-1 m-1 ">  {{$user->active?__('btn.dactivate'):__('btn.activate')}} </a>
            <a href="{{route('user.index')}}" class="btn btn-outline-dark btn-sm py-1 m-1 ">  {{__('btn.back')}} </a>
        </div>
    </nav>
                        ...
                        <div class="main-profile-overview">
                            ...
                            <div class="d-flex justify-content-center mg-b-20">
                                <div>
                                    ...
                                    <p class="main-profile-name-text"> {{$user->phone??''}} </p>
                                    <p class="main-profile-name-text"> {{$user->created_at->diffForHumans()}} </p>
                                </div>
                            </div>
